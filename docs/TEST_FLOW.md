...
`python3 lab.py propose-mock --output proposals/out.json` emits a deterministic offline proposal.
`python3 lab.py evaluate-proposal --mock` imports, builds, verifies, and measures one offline proposal.
